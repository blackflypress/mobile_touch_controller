...
class Example extends Phaser.Scene{
    ...
    constructor(){
      ...
      create() {
        ...
        this.textAngle = this.add.bitmapText(50, 950 , 'p2', `Angle:`, 72).setOrigin(0,0).setScale(.5,.5).setTint(0x00ff00);
        this.textDistance = this.add.bitmapText(50, 1000 , 'p2', `Distance:`, 72).setOrigin(0,0).setScale(.5,.5).setTint(0x00ff00);
