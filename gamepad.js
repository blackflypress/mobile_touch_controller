...
class Example extends Phaser.Scene{
    ...
    constructor(){
      ...
      create() {
        ...
        this.textAngle = this.add.bitmapText(50, 950 , 'p2', `Angle:`, 45).setOrigin(0,0).setTint(0x00ff00);
        ...
        this.touchButton.setScale(6);// scale up
        this.touchOrigin.setScale(6);
        this.touchCurrent.setScale(6);
        ...
        update() {
          ...
          if (this.touch == true) {
            if (this.movePointer.active && this.movePointer.downX < config.width/2) { // handle analog control
              ...
              // console.log('move');
              this.touchOrigin.alpha = .6; // increase opacity
              this.touchCurrent.alpha = .6;
